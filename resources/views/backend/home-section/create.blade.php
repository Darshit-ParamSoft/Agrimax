        ...
        <div class="col-lg-10">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Add New Home Section</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('home-sections.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('section_key') is-invalid @enderror"
                                id="section_key" name="section_key" value="{{ old('section_key') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('section_value') is-invalid @enderror"
                                ...
                                placeholder="Enter content for this section (supports HTML)" required>{{ old('section_value') }}</textarea>
                            @error('section_value')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success">
                                <i class="uil uil-check"></i> Create
                            </button>
